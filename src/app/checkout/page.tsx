...
export const metadata: Metadata = {
  title: 'Finalizar Compra | CLOSING®',
};
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] pt-32 pb-20 flex items-center justify-center">
      <div className="text-center">
        <h1 className="font-display text-4xl text-white tracking-widest mb-4">CHECKOUT</h1>
        <p className="text-white/60 mb-8">Página de pago en construcción. Aquí iría la integración con WebPay.</p>
